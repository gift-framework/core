...
Formally verified mathematical relations from the GIFT framework. 460+ certified relations, **14 published axioms**, all theorems proven in **Lean 4** (128 files, 2638 build jobs).
