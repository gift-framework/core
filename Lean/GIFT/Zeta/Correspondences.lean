...
theorem gamma1_near_dimG2 : |gamma 1 - dim_G2| < 14 / 100 := by
  ...
  have hdim : (dim_G2 : ℝ) = 14 := by simp [dim_G2]
  calc |gamma 1 - dim_G2|
      = |gamma 1 - 14| := by rw [hdim]
    _ ≤ |gamma 1 - 14134725 / 1000000| + |14134725 / 1000000 - 14| := abs_sub_abs_le_abs_sub _ _
...
theorem gamma2_near_b2 : |gamma 2 - b2| < 3 / 100 := by
  ...
  have hb2 : (b2 : ℝ) = 21 := by simp [b2]
  calc |gamma 2 - b2|
      = |gamma 2 - 21| := by rw [hb2]
    _ ≤ |gamma 2 - 21022040 / 1000000| + |21022040 / 1000000 - 21| := abs_sub_abs_le_abs_sub _ _
...
theorem gamma20_near_b3 : |gamma 20 - b3| < 15 / 100 := by
  ...
  have hb3 : (b3 : ℝ) = 77 := by simp [b3]
  calc |gamma 20 - b3|
      = |gamma 20 - 77| := by rw [hb3]
    _ ≤ |gamma 20 - 77144840 / 1000000| + |77144840 / 1000000 - 77| := abs_sub_abs_le_abs_sub _ _
...
theorem gamma60_near_heegner163 : |gamma 60 - 163| < 4 / 100 := by
  ...
  calc |gamma 60 - 163|
    _ ≤ |gamma 60 - 163030710 / 1000000| + |163030710 / 1000000 - 163| := abs_sub_abs_le_abs_sub _ _
...
theorem gamma107_near_dimE8 : |gamma 107 - dim_E8| < 11 / 100 := by
  ...
  have hdim : (dim_E8 : ℝ) = 248 := by simp [dim_E8]
  calc |gamma 107 - dim_E8|
      = |gamma 107 - 248| := by rw [hdim]
    _ ≤ |gamma 107 - 248101990 / 1000000| + |248101990 / 1000000 - 248| := abs_sub_abs_le_abs_sub _ _
...
theorem gamma1_relative_precision : |gamma 1 - dim_G2| / dim_G2 < 1 / 100 := by
  ...
  have hdim : (dim_G2 : ℝ) = 14 := by simp [dim_G2]
  have hpos : (dim_G2 : ℝ) > 0 := by simp [dim_G2]
